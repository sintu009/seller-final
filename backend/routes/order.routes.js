...
router.get('/admin', protect, authorize('admin', 'superadmin'), orderController.getOrdersForAdmin);
...
router.put('/:id/approve', protect, authorize('admin', 'superadmin'), orderController.adminApproveOrder);
router.put('/:id/reject', protect, authorize('admin', 'superadmin'), orderController.adminRejectOrder);
