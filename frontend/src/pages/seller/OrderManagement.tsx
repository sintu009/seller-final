      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Sync and manage orders from Amazon, Flipkart, Meesho & more
          </p>
        </div>
              ...
              {filteredOrders.map((order) => (
                ...
                >
                  ...
                  <td className="py-4 px-6">
                    ...
                    <div
                      className={`text-xs px-2 py-1 rounded-full font-medium mt-1 inline-block ${getPaymentStatusColor(
                        order.paymentStatus
                      )}`}
                    >
                      {order.paymentStatus}
        ...
        {filteredOrders.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400">
              Try adjusting your search filters or sync orders from platforms
            </p>
          </div>
        )}
      </div>
