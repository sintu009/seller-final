...
const socket = io("https://seller-final-2.onrender.com", {
...
const AdminOverview = () => {
    ...
    const recentActivities = [
        ...
        {
            type: 'product',
            message: 'Product "Wireless Headphones Pro" approved for supplier Kumar Electronics',
            time: '15 minutes ago',
            icon: CheckCircle,
        ...
        {
            type: 'kyc',
            message: 'KYC documents submitted by supplier "Electronics Manufacturing Ltd"',
            time: '1 hour ago',
            icon: AlertTriangle,
    ...
    const pendingApprovals = [
        ...
        { type: 'Supplier KYC', count: 5, color: 'bg-emerald-100 text-emerald-800' },
        { type: 'Product Approval', count: 15, color: 'bg-purple-100 text-purple-800' },
        { type: 'Payout Requests', count: 3, color: 'bg-orange-100 text-orange-800' }
    ];
                            ...
                            <div key={index} className="flex items-center justify-between">
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-500">{platform.orders.toLocaleString()} orders</div>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <div className="text-sm font-semibold text-gray-900">{platform.value}%</div>
                                </div>
                            </div>
                        ))}
                    </div>
                    ...
                    <div className="space-y-4">
                        {pendingApprovals.map((approval, index) => (
                            <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-md">
                                ...
                                <div className="flex items-center space-x-3">
                                    <span className={`px-3 py-1 text-sm font-medium rounded-full ${approval.color}`}>
